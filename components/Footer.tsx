    ...
    return (
        <section className='w-full bg-[#121212] py-14 px-10'>
            <div className='w-full grid grid-cols-5 gap-8 justify-center items-start '>
                <div>
                    <Image src={"/logo-white.svg"} alt="rey logo" className='grayscale w-full mx-auto right-0 h-10 aspect-auto' width={200} height={20} />
                ...
                <div>
                    <p className='text-left mt-16 text-[#7D7D7D] hover:text-white cursor-pointer'>
                        <Link href="mailto:asad.ahmed2813@gmail.com" title="e-mail" >
                            asad.ahmed2813@gmail.com
                        </Link>

                    </p>
                    <p className='text-left mt-2 text-[#7D7D7D] hover:text-white cursor-pointer'>
